...
from typed_python.compiler.type_wrappers.range_wrapper import Range
...
def pythonObjectRepresentation(context, f, owningGlobalScopeAndName=None):
    ...
    if f is range:
        return TypedExpression(context, native_ast.nullExpr, PythonTypeObjectWrapper(Range), False)
