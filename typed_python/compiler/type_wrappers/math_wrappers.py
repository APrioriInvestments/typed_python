    ...
    def convert_call(self, context, expr, args, kwargs):
        ...
        if self.typeRepresentation is ldexp and len(args) == 2 and not kwargs:
            ...
            if argType1 not in (Float32, float):
                arg1 = arg1.convert_to_type(float, ConversionLevel.Implicit)
                argType1 = float

                if arg1 is None:
                    return None

            arg2 = arg2.convert_to_type(int, ConversionLevel.Implicit)
            if arg2 is None:
                return None
        ...
        if self.typeRepresentation is gcd and len(args) == 2 and not kwargs:
            ...
            arg1 = arg1.convert_abs().convert_to_type(UInt64)
            arg2 = arg2.convert_abs().convert_to_type(UInt64)
        ...
        if (not kwargs or self.typeRepresentation is isclose) and len(args) == 2:
            ...
            if not arg1.expr_type.is_arithmetic or arg1.expr_type.typeRepresentation not in (Float32, float):
                arg1 = arg1.toFloat64()
            if not arg2.expr_type.is_arithmetic or arg2.expr_type.typeRepresentation not in (Float32, float):
                arg2 = arg2.toFloat64()
