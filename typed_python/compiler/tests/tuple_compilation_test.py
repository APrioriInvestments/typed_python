...
class TestTupleCompilation(unittest.TestCase):
    ...
    def test_iterating(self):
        ...
        self.assertEqual(tupToString(Tuple(int, str)((0, "a"))), ["0", "a"])
    ...
    def test_named_tuple_replacing_error(self):
        ...
        with self.assertRaisesRegex(
            Exception,
            "The arguments list contain names 'c' which are not in the tuple definition.",
        ):
            f1(n1)
        ...
        with self.assertRaisesRegex(
            Exception,
            "The arguments list contain names 'c, d, e' which are not in the tuple definition.",
        ):
            f2(n1)
