...
public:
    ...
    static PyObject* newPyFunctionOverload(Function* f, int64_t overloadIndex);

    static int init(PyFunctionOverload *self, PyObject *args, PyObject *kwargs);
};
